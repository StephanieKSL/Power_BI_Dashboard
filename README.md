...
![Project1_Overwiew](/Recording%202025-11-21%20143826.gif)
...
Used **Cards** to display key metrics and **Table** to provide granular, sortable data.
...
- **🖱️ Interactive Reporting :**
    ...
    - **Drill-Through :** To navigate from a high-level summary to a contectual, detailed view. 

    ### Page 1 : Hight-Level Market View

    ![Project1_Page 1](/Prject1_Page1.png)

    This is your mission control for the data job market. It showcases key KPIs like total job count, median salaries, and top job titles to give you a quick understanding of what's happening in the job market at a glance.

    ### Page 2 : Job Title Drill Through

    ![Project1_Page 2](/Project1_Page2.png)
